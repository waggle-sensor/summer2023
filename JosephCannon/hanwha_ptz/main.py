...
Camera1 = main_to_update.CameraControl('10.31.81.11', 'admin', '')

# Camera1.relative_control(80, 30)
# Camera1.continuous_control(5)
...
# Camera1.moving_to_preset_position('Preset2')
# Camera1.zoom_out()
# Camera1.aux_control('WiperOn')
# Camera1.attributes_information()
# Camera1.swing_control(0)
